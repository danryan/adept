...
#       def step(message, options = {})
#         RSpec.world.reporter.example_step_started(self, :step, message, options)
#         if block_given? && !options[:pending]
#           begin
#             yield
#           rescue Exception => e
#             RSpec.world.reporter.example_step_failed(self, :step, message, options)
#             raise e
#           end
#           RSpec.world.reporter.example_step_passed(self, :step, message, options)
#         else
#           RSpec.world.reporter.example_step_pending(self, :step, message, options)
#         end
#       end
